...
impl Psbt {
    ...
    pub(crate) fn output_type(&self, input_index: usize) -> Result<OutputType, SignError> {
        let input = self.checked_input(input_index)?;
        let utxo = self.spend_utxo(input_index)?;
...
mod tests {
    ...
    fn psbt_insufficient_byte_size() {
        ...
        assert!(matches!(got, Error::ConsensusEncoding(_)));
    }
    ...
    fn serde_psbt() {
        ...
        use crate::v0::bitcoin::map::Input;
        ...
        let keypaths: BTreeMap<bitcoin::PublicKey, KeySource> = vec![(
    ...
    mod bip_vectors {
        ...
        #[test]
        fn valid_vector_6() {
            // let psbt = hex_psbt("70736274ff01003f0200000001ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff0000000000ffffffff010000000000000000036a010000000000000a0f0102030405060708090f0102030405060708090a0b0c0d0e0f0000").map_err(|e| {
            //     println!("{}", e);
            // }).unwrap();
    ...
    fn combine_psbt_fuzz_3628() {
        ...
        let mut psbt1 =
            hex_psbt(include_str!("../../../tests/data/psbt_fuzz1.hex").trim_end()).unwrap();
        let psbt2 =
            hex_psbt(include_str!("../../../tests/data/psbt_fuzz2.hex").trim_end()).unwrap();
